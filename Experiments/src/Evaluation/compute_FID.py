...
def parse_arguments():
    ...
    parser.add_argument("--N2", help="Ending batch index", type=int, default=1)
    parser.add_argument("--batch_size_samples", help="Size of each sample batch", type=int, default=10000)
